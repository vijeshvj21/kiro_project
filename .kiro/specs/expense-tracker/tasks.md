...
- [x] 2. Data models and JPA entities
  ...
  - [x]* 2.3 Write repository integration tests (`@DataJpaTest`)
...
- [x] 3. Exception hierarchy and global error handler
  - [x] 3.1 Create custom exception classes and `GlobalExceptionHandler`
  ...
  - [x]* 3.2 Write unit tests for `GlobalExceptionHandler`
...
- [x] 4. DTOs — request and response objects
...
- [x] 5. Category service and controller
  ...
  - [x] 5.2 Implement `DataInitializer`
  ...
  - [x] 5.3 Implement `CategoryController`
  ...
  - [x]* 5.4 Write property tests for `CategoryService` (jqwik)
  ...
  - [x]* 5.5 Write unit tests for `CategoryController` (MockMvc)
...
- [x] 7. Expense service and controller
  - [x] 7.1 Implement `ExpenseService`
  ...
  - [x] 7.2 Implement `ExpenseController`
  ...
  - [x]* 7.3 Write property tests for expense creation and validation (jqwik, `@SpringBootTest`)
  ...
  - [x]* 7.4 Write property tests for expense management (jqwik)
  ...
  - [x]* 7.5 Write unit tests for `ExpenseController` (MockMvc)
...
- [x] 8. Weekly and monthly expense views
  - [x] 8.1 Implement weekly view in `ExpenseService`
  ...
  - [x] 8.2 Implement monthly view in `ExpenseService`
  ...
  - [x] 8.3 Expose weekly and monthly endpoints in `ExpenseController`
  ...
  - [x]* 8.4 Write property tests for weekly view (jqwik)
  ...
  - [x]* 8.5 Write property tests for monthly view (jqwik)
...
- [x] 10. Comparison service and endpoints
  - [x] 10.1 Implement `ComparisonService`
  ...
  - [x] 10.2 Expose comparison endpoints in `ExpenseController`
    - Map `GET /api/v1/expenses/comparison/monthly?year={y}&month={m}` and `GET /api/v1/expenses/comparison/yearly?year={y}`
    - _Requirements: 9.1–9.7, 10.1–10.5_

  - [x]* 10.3 Write property tests for month-over-month comparison (jqwik)
  ...
  - [x]* 10.4 Write property tests for year-over-year comparison (jqwik)
  ...
  - [x]* 10.5 Write unit tests for `ComparisonService`
...
- [x] 11. Report service and controller
  - [x] 11.1 Implement `ReportService`
  ...
  - [x] 11.2 Implement `CsvReportGenerator`
  ...
  - [x] 11.3 Implement `PdfReportGenerator`
  ...
  - [x] 11.4 Implement `ReportController`
  ...
  - [x]* 11.5 Write property tests for report service (jqwik)
  ...
  - [x]* 11.6 Write unit tests for `ReportService` predefined period resolution
    - Test all 5 predefined periods resolve to the correct `startDate` and `endDate`
    - _Requirements: 11.7_

  - [x]* 11.7 Write unit tests for `CsvReportGenerator` and `PdfReportGenerator`
